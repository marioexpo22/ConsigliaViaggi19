...
public class HomeController extends AsyncTask<String,Void,String> {
    Context context;
    RecyclerView recyclerView;

    public HomeController(Context ctx, RecyclerView recyclerView){
        context = ctx;
    ...
    protected String doInBackground(String... strings) {
        ...
        String link = "http://192.168.1.22/myapp/homeConsigliati.php";
